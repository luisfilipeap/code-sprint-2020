...
import operator
import pylops
class OpTomo(pylops.LinearOperator):
    ...
    It can also be used in minimization methods of the :mod:`pylops` module::

        W = astra.OpTomo(proj_id)
        output = pylops.lsqr(W,sinogram)
    ...
    def __mul__(self,v):
        ...
        return pylops.LinearOperator.__mul__(self, v)
...
class OpTomoTranspose(pylops.LinearOperator):
    ...
    def __mul__(self,s):
        ...
        return pylops.LinearOperator.__mul__(self, s)